...
-------------------------------------
This script fits a multivariable linear regression model on any dataset and reports how changes in each feature affect the target variable.

Author: Morvarid Azheian
"""
...
def analyze_enterprise_regression(
    ...
    if len(feature_cols) == 0:
        raise ValueError("❌ No feature columns found besides target.")
